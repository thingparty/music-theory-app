// guitar-p4-app.js — Main controller for all-fourths guitar page
...
const App = (() => {
  ...
  function init() {
    ...
    GuitarP4Fretboard.init('fretboard-container', onFretPlayed);
    setupModeButtons();
    onKeySelected('C');
  ...
  function updateFretboard() {
    ...
    GuitarP4Fretboard.setActiveNotes(chromaticNotes, root, state.selectedKey);
    GuitarP4Fretboard.refresh('fretboard-container');
  }
