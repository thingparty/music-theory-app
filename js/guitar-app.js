// guitar-app.js — Main controller for guitar page
...
const App = (() => {
  ...
  function init() {
    ...
    GuitarFretboard.init('fretboard-container', onFretPlayed);
    setupModeButtons();
    onKeySelected('C');
  ...
  function updateFretboard() {
    ...
    GuitarFretboard.setActiveNotes(chromaticNotes, root, state.selectedKey);
    GuitarFretboard.refresh('fretboard-container');
  }
